        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/websites/demo/" class="<?= urlIs("/websites/demo/") ? "bg-gray-900 text-white " : "text-gray-300 "?>hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
              <a href="/websites/demo/about" class="<?= urlIs("/websites/demo/about")? "bg-gray-900 text-white " : "text-gray-300 "?>hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
              <a href="/websites/demo/notes" class="<?= urlIs("/websites/demo/notes")? "bg-gray-900 text-white " : "text-gray-300 "?>hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Notes</a>
              <a href="/websites/demo/contact" class="<?= urlIs("/websites/demo/contact") ? "bg-gray-900 text-white " : "text-gray-300 "?>hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
